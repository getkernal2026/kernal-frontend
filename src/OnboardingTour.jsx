  ...
  demand: {
    ...
    steps: [
      ...
      },
      {
        targetId: 'kernal-topbar',
        position: 'bottom',
        title: 'Forecast Horizon & Filters',
        body: "Adjust the forecast horizon (7, 14, or 30 days) and filter by product category or velocity tier (Fast / Medium / Slow movers) to focus on what needs attention right now.",
      },
    ],
  },
  ...
  logistics: {
    ...
    steps: [
      ...
      },
      {
        targetId: 'kernal-topbar',
        position: 'bottom',
        title: 'Routes, Deliveries & POD',
        body: "Use the tabs to switch between Route Planning, Active Deliveries, Driver Assignments, and the Proof of Delivery archive. Every delivery signature and photo is stored permanently.",
      },
    ],
  },
  ...
  b2b: {
    ...
    steps: [
      ...
      },
      {
        targetId: 'kernal-topbar',
        position: 'bottom',
        title: 'Customer Access & Catalog Control',
        body: "Use the Customers tab to enable or disable portal access per account. Use the Catalog tab to control which products are visible to each customer, and at which prices.",
      },
    ],
  },
  ...
  pricing: {
    ...
    steps: [
      ...
      },
      {
        targetId: 'kernal-topbar',
        position: 'bottom',
        title: 'Contract Pricing & Exceptions',
        body: "For customers with negotiated contract prices, use the Contracts tab to lock specific item prices for a date range. The Exceptions tab shows any manually approved one-time price overrides.",
      },
    ],
  },
  ...
  accounting: {
    ...
    steps: [
      ...
      },
      {
        targetId: 'kernal-topbar',
        position: 'bottom',
        title: 'Close-Out, Payments & Statements',
        body: "Switch tabs for Payments received, Daily Close-Out reconciliation, and Financial Statements (P&L, Balance Sheet, Cash Flow). The General Ledger module handles your full chart of accounts.",
      },
    ],
  },
  ...
  gl: {
    ...
    steps: [
      ...
      },
      {
        targetId: 'kernal-topbar',
        position: 'bottom',
        title: 'Period Close & Financials',
        body: "The Period Close tab walks you through month-end reconciliation steps. The Financial Statements tab generates your P&L, balance sheet, and cash flow statement for any date range.",
      },
    ],
  },
